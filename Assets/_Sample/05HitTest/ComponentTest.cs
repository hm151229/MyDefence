...
namespace Sample
{
    ...
    public class ComponentTest : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // ComponentTest 스크립트가 붙어있는 게임오브젝트의 객체(인스턴스) 가져오기
            //this.transform
            //this.transform.GetComponet<컴포넌트 타입>()
            //this.gmaeObject
            //this.gmaeObject.GetComponet<컴포넌트 타입>()
            //this.GetComponet<컴포넌트 타입>()

            //[2] 
            //이동 목표 지점
            //targetPosition = new Vector3(7f, 1f, 8f); //타겟 위치
