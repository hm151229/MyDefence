...
namespace Sample
{
    ...
    public class EventTest : MonoBehaviour
    {
        ...
        {
            Debug.Log("[7-1] OnEnable 실행");  //1회 실행 - 활성화 할 때마다 
        ...
        {
            Debug.Log("[7-1] OnDisable 실행");  //1회 실행 - 비활성화 할 때마다           
        }

        private void OnDestroy()
        {
            Debug.Log("[6] OnDestroy 실행");  //하이라키 창에서 삭제될 때 (킬) - 1회 실행
        }
    }
}
